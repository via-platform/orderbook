...
module.exports = class Orderbook {
        ...
        return $.div({classList: 'orderbook table'},
            ...
            $.div({classList: 'tbody'},
                ...
                $.div({classList: 'spread'},
                    ...
                    $.div({}),
                    $.div({classList: 'value', ref: ''}, this.book ? this.book.spread().toFixed(this.precision) : '00.00')
                ),
    ...
    changeSymbol(symbol){
        if(this.symbol !== symbol){
            ...
            if(this.symbol && _.isFunction(this.symbol.orderbook)){
                this.book = this.symbol.orderbook();
