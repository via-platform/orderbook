...
module.exports = class OrderbookView {
    ...
    render(){
        ...
        return $.div({classList: 'orderbook table'},
            ...
            $.div({classList: 'orderbook-tools bottom'},
                $.div({classList: 'orderbook-tools-left'},
                ...
                $.div({classList: 'orderbook-tools-right'},
                    ...
                    $.div({classList: 'aggregation-value'}, (1 / this.aggregation)), //TODO this turns to scientific notation at some point
