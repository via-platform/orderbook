...
module.exports = class Orderbook {
    ...
    constructor({manager, omnibar}, state = {}){
        ...
        this.disposables.add(via.config.observe('core.numberFormat', () => etch.update(this)));
        ...
        return $.div({classList: 'orderbook', tabIndex: -1},
            $.div({classList: 'orderbook-tools toolbar'},
                ...
                $.div({classList: 'aggregation-value'},
                    via.fn.number.formatString(
                        (1 / this.aggregation).toFixed((this.aggregation <= 1) ? 2 : Math.max(this.aggregation.toString().length - 1, 2))
                    )
                ),
            ...
            $.div({classList: 'orderbook-table', ref: 'table'},
                ...
                $.div({classList: 'spread'},
                    ...
                    $.div({}),
                    $.div({classList: 'value'}, this.market ? via.fn.number.formatPrice(this.market.orderbook.spread(), this.market) : '00.00')
                ),
