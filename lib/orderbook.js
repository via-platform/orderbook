...
module.exports = class Orderbook {
    ...
    constructor(params = {}){
        ...
        this.height = 0;
        this.orderbook = null;
        this.aggregation = params.aggregation || 100;
        ...
        return $.div({classList: 'orderbook', tabIndex: -1},
            ...
            $.div({classList: 'orderbook-table', ref: 'table'},
                ...
                $.div({classList: 'spread'},
                    ...
                    $.div({}),
                    $.div({classList: 'value'}, this.orderbook ? this.orderbook.spread().toFixed(this.market.precision.price) : '00.00')
                ),
